...
### 1.2 项目愿景
基于微软 [markitdown](https://github.com/microsoft/markitdown) 项目构建，打造一款**对 AI 新手极度友好**的多模态智能体前端应用。用户可以通过多种输入方式与 AI 交互，系统调用大模型 API 解决问题。核心创新在于将复杂的 AI Agent 配置（如 MCP 工具、模型参数）通过**拟物化的"机器人能力"概念**进行图形化呈现，让用户像在配置一个机器人的"五官"与"四肢"一样直观地配置 AI 能力。
